...
export const buildRoutePrompt = ( args: ResolveGenerationRouteArgs ): string => {
	...
	return [
		PIPELINE_STEP.ROUTE,
		'',
		'Return strict JSON: { "mode": "edit" | "structure" | "generate", "reason": "short explanation" }',
		'',
		...
		'When the user asks to remove or delete a block, always choose "structure" — never "generate".',
		'When transformEditPreferred is true, choose "edit" or "structure" unless the user explicitly asks for a new layout or redesign.',
