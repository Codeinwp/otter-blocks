...
export const BLOCK_GENERATION_SYSTEM_PROMPT = [
	...
	'',
	'Pipeline overview:',
	'1. ROUTE — decide "edit" (attribute changes), "structure" (add/remove/move blocks), or "generate" (new or redesigned layout).',
	...
	'   Use "remove" to delete block ids. Use "insert" to add a block under parentId at index.',
