...
const Edit = ({
	...
	const inlineStyles = {
		...
		'--width-tablet': attributes.containerWidthTablet ?? attributes.containerWidth,
		'--width-mobile': attributes.containerWidthMobile ?? attributes.containerWidth,
		...
		'--value-font-sizeTablet': optionalUnit( attributes.valueFontSizeTablet ),
		'--value-font-sizeMobile': optionalUnit( attributes.valueFontSizeMobile ),
