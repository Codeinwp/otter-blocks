...
import SliderControls, { SliderControlsBullets } from './components/slider-controls.js';
...
const deprecated = [{
	...
	// Same markup as the current save, before the redundant title attribute (a duplicate of alt) was dropped from the slide images.
	attributes: {
		...metadata.attributes
	},
