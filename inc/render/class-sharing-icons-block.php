	...
	public static function get_social_profiles( $context = null ) {
		...
		$social_attributes = array(
			'facebook'  => array(
				...
				'aria_label' => esc_html__( 'Share on Facebook', 'otter-blocks' ),
			...
			'twitter'   => array(
				'label'      => '',
				'aria_label' => esc_html__( 'Share on X', 'otter-blocks' ),
			...
			'linkedin'  => array(
				...
				'aria_label' => esc_html__( 'Share on LinkedIn', 'otter-blocks' ),
			...
			'pinterest' => array(
				...
				'aria_label' => esc_html__( 'Share on Pinterest', 'otter-blocks' ),
			...
			'tumblr'    => array(
				...
				'aria_label' => esc_html__( 'Share on Tumblr', 'otter-blocks' ),
			...
			'reddit'    => array(
				...
				'aria_label' => esc_html__( 'Share on Reddit', 'otter-blocks' ),
			...
			'whatsapp'  => array(
				...
				'aria_label' => esc_html__( 'Share on WhatsApp', 'otter-blocks' ),
			...
			'email'     => array(
				...
				'aria_label' => esc_html__( 'Share via Email', 'otter-blocks' ),
			...
			'telegram'  => array(
				...
				'aria_label' => esc_html__( 'Share on Telegram', 'otter-blocks' ),
			...
			'mastodon'  => array(
				...
				'aria_label' => esc_html__( 'Share on Mastodon', 'otter-blocks' ),
			...
			'comments'  => array(
				...
				'aria_label'   => esc_html__( 'Leave a comment', 'otter-blocks' ),
			...
			'threads'   => array(
				...
				'aria_label'   => esc_html__( 'Share on Threads', 'otter-blocks' ),
	...
	public function render( $attributes ) {
		...
		foreach ( $social_attributes as $key => $icon ) {
			if ( 'className' !== $key && $this->is_active( $attributes[ $key ] ) ) {
				...
				$html .= '<a class="social-icon is-' . esc_html( $key ) . '" aria-label="' . $icon['aria_label'] . '" href="' . esc_url( $icon['url'] ) . '"' . $new_tab . '>';
				$html .= $icon['svg'];
