			...
			array(
				...
				'properties' => array(
					...
					array(
						...
						'condition'      => function( $attrs ) {
							return isset( $attrs['backgroundOverlayType'] ) && 'image' === $attrs['backgroundOverlayType'] && isset( $attrs['backgroundOverlayImageURL'] ) && $this->is_image_url( $attrs['backgroundImageURL'] );
						},
					),
					array(
						'property'  => 'background',
